...
void test_universal_selectors(void) {
    ...
    // Strict mode: * is usually kept because it matches everything, but let's test our implementation
    OptimizerConfig config_strict = {
        .used_classes = used,
        .class_count = 1,
        .used_tags = NULL,
        .tag_count = 0,
...
void test_complex_selectors_logic(void) {
    const char *css = ".parent .child { color: red; } .unused .child { color: blue; }";
